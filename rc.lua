...
mymainmenu = awful.menu({
    items = {
        ...
        { "hibernate", function() awful.util.spawn_with_shell("systemctl hibernate") end },
        { "lock", function() wful.util.spawn_with_shell("light-locker-command --lock") end },
    }
})
...
globalkeys = awful.util.table.join(awful.key({ modkey, }, "s", hotkeys_popup.show_help,
    ...
    -- Media
    awful.key({}, "XF86AudioLowerVolume", function() awful.util.spawn_with_shell('.config/awesome/bin/volume -5%'); volume_update() end),
    awful.key({}, "XF86AudioRaiseVolume", function() awful.util.spawn_with_shell('.config/awesome/bin/volume +5%'); volume_update() end),
    ...
    awful.key({ modkey, "Shift", "Control" }, "l", function() awful.util.spawn_with_shell('autopass') end),
    ...
    awful.key({ modkey }, "t", function() awful.spawn(terminal, { screen = mouse.screen.index }) end),
